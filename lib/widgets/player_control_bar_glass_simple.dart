...
class PlayerControlBarGlassSimple extends StatefulWidget {
  const PlayerControlBarGlassSimple({
    Key? key,
  }) : super(key: key);

  @override
  State<PlayerControlBarGlassSimple> createState() => _PlayerControlBarGlassSimpleState();
}

class _PlayerControlBarGlassSimpleState extends State<PlayerControlBarGlassSimple>
