...
class _PlayerControlBarState extends State<PlayerControlBar> with TickerProviderStateMixin {
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: settings.usePlayerGlass
                            ? Theme.of(context).colorScheme.surface.withOpacity(settings.glassOpacity)
                        ...
                        return Material(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              padding: const EdgeInsets.all(8),
                              child: AnimatedScale(
                                scale: _isHoveringPlay ? _hoverScale : _normalScale,
                                duration: _animationDuration,
                                child: Icon(
                    ...
                    return Material(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(8),
                          child: AnimatedScale(
                            scale: _isHoveringPlaylist ? _hoverScale : _normalScale,
                            duration: _animationDuration,
                            child: Icon(
                              AppIcons.playlist,
