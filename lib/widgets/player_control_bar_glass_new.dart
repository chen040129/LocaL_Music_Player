...
class PlayerControlBarGlassNew extends StatefulWidget {
  const PlayerControlBarGlassNew({
    Key? key,
  }) : super(key: key);

  @override
  State<PlayerControlBarGlassNew> createState() => _PlayerControlBarGlassNewState();
}

class _PlayerControlBarGlassNewState extends State<PlayerControlBarGlassNew>
