...
class AlbumsPage extends StatefulWidget {
  ...
  const AlbumsPage({Key? key, this.navigateToAlbum, this.onSidebarToggle}) : super(key: key);
                ...
                MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      // 通知父组件展开侧边栏并导航到专辑页面
                      final navigationProvider = Provider.of<NavigationProvider>(context, listen: false);
                      navigationProvider.changePage(AppPage.albums);
                      // 需要父组件实现展开侧边栏的逻辑
                        ...
                        return MouseRegion(
                          ...
                          child: GestureDetector(
                            ...
                            child: MaskCard(
                              ...
                              accentColor: albumMusics.isNotEmpty && albumMusics.first.coverColor != null
                                        ...
                                        itemBuilder: (context, musicIndex) {
                                          ...
                                          return ListTile(
                                            ...
                                            onTap: () {
                                              ...
                                              final musicList = musicProvider.getMusicByAlbum(album);
