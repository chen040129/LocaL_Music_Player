...
class CustomSliderTrackShape extends SliderTrackShape {
  ...
  void paint(
    ...
    final double relativeThumbPosition =
        (thumbCenter.dx - trackRect.left) / trackRect.width;
    final double activeTrackWidth =
        trackRect.width * relativeThumbPosition.clamp(0.0, 1.0);
...
class _LyricsPageState extends State<LyricsPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _coverTransitionController!.value = 1.0; // 初始状态：完全可见
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        borderRadius:
                                                                            BorderRadius.circular(0),
                                                                        child: _SyncedCoverSwitcher(
                                                                          transitionAnimation: _coverTransitionAnimation ?? const AlwaysStoppedAnimation(1.0),
                                                                          isTransitioning: _isCoverTransitioning,
                                                                          previousCoverArt: _previousCoverArt,
                                                                          currentCoverArt: _currentCoverArt,
                                                                          noCoverWidget: Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChangeEnd:
                                                                            ...
                                                                            playerProvider.seekToPercent(value.clamp(0.0,
                                                                                1.0));
                                                                          },
                                                                        ),
                                                                      ),
                                                                      ...
                                                                      children: [
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: IconButton(
                                                                                      ...
                                                                                      icon: AnimatedScale(
                                                                                        ...
                                                                                        child: Icon(
                                                                                          _volume > 0 ? CupertinoIcons.speaker_2_fill : CupertinoIcons.speaker_slash,
                                                                                          color: _showVolumeControl ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.7),
                                                                        ...
                                                                        if (!_showVolumeControl) ...[
                                                                          ...
                                                                          MouseRegion(
                                                                            ...
                                                                            onEnter: (_) =>
                                                                                setState(() => _isPlaylistHovered = true),
                                                                            onExit: (_) =>
                                                                                setState(() => _isPlaylistHovered = false),
                                                                            child:
                                                                                GestureDetector(
                                                                              onTap: () {
                                                                                _animateToPlaylist();
                                                                              ...
                                                                              child: AnimatedContainer(
                                                                                ...
                                                                                child: AnimatedScale(
                                                                                  ...
                                                                                  child: Icon(
                                                                                    ...
                                                                                    color: _isPlaylistHovered ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.7),
                                                                                    size: 20,
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                                    ...
                                                                                    child: AnimatedContainer(
                                                                                      ...
                                                                                      child: AnimatedScale(
                                                                                        ...
                                                                                        child: Icon(
                                                                                          ...
                                                                                          color: _isTimerHovered ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.7),
                                                                                          size: 20,
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                          ...
                                                                          MouseRegion(
                                                                            cursor:
                                                                                SystemMouseCursors.click,
                                                                            onEnter: (_) =>
                                                                                setState(() => _isPlayModeHovered = true),
                                                                            onExit: (_) =>
                                                                                setState(() => _isPlayModeHovered = false),
                                                                            child:
                                                                                GestureDetector(
                                                                              ...
                                                                              child: AnimatedContainer(
                                                                                ...
                                                                                child: AnimatedScale(
                                                                                  ...
                                                                                  child: Icon(
                                                                                    ...
                                                                                    color: _isPlayModeHovered ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.7),
                                                                                    size: 20,
                                                                                  ),
                                                                                ),
                                                                              ),
  ...
  void _showTimerDialog(BuildContext context) {
    ...
    int remainingSeconds = playerProvider.originalTimerMinutes != null
        ? playerProvider.originalTimerMinutes! * 60
        : 0;
                    ...
                    SliderTheme(
                      ...
                      child: Slider(
                        value: (tempTimerMinutes ??
                                (playerProvider.originalTimerMinutes ?? 30))
                            .toDouble(),
                        min: 0,
                        max: 180,
                        divisions: 180,
                        ...
                        GestureDetector(
                          ...
                          onHorizontalDragUpdate: (details) {
                            setState(() {
                              ...
                              _coverDragOffset =
                                  dragDistance.clamp(-200.0, 200.0);
                            });
                          },
                          onHorizontalDragEnd: (details) {
                            final dragDistance =
  ...
  Widget _buildTimerWidget(BuildContext context, ColorScheme colorScheme) {
    ...
    if (playerProvider.isPlaying) {
      return StreamBuilder<int>(
        ...
        builder: (context, snapshot) {
          ...
          if (playerProvider.timerStartTime == null) {
            // 暂停状态，显示保存的剩余时间
            remaining = playerProvider.pausedRemainingSeconds ??
                (playerProvider.originalTimerMinutes! * 60);
            progress = remaining / (playerProvider.originalTimerMinutes! * 60);
          } else {
            // 运行状态，计算实际剩余时间
            final elapsed = DateTime.now()
                .difference(playerProvider.timerStartTime!)
                .inSeconds;
      ...
      // 歌曲未播放，显示静态的剩余时间
      int remaining = playerProvider.pausedRemainingSeconds ??
          (playerProvider.originalTimerMinutes! * 60);
...
/// 同步模糊背景组件
/// 由父级 _LyricsPageState 统一驱动动画，确保封面和背景完全同步
...
/// 同步封面切换组件
/// 由父级 _LyricsPageState 统一驱动动画，确保封面和背景完全同步
class _SyncedCoverSwitcher extends StatelessWidget {
  final Animation<double> transitionAnimation;
  final bool isTransitioning;
  final Uint8List? previousCoverArt;
  final Uint8List? currentCoverArt;
  final Widget noCoverWidget;

  const _SyncedCoverSwitcher({
    Key? key,
    required this.transitionAnimation,
    required this.isTransitioning,
    required this.previousCoverArt,
    required this.currentCoverArt,
    required this.noCoverWidget,
  }) : super(key: key);
