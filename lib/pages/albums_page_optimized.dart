...
class AlbumsPageOptimized extends StatefulWidget {
  ...
  @override
  State<AlbumsPageOptimized> createState() => _AlbumsPageOptimizedState();
}

class _AlbumsPageOptimizedState extends State<AlbumsPageOptimized> {
  // 排序方式
  ...
  // 专辑音乐缓存 - 避免重复查询
  final Map<String, List<MusicInfo>> _albumMusicCache = {};
